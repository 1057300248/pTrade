...
- 免费日 K（新浪 / 腾讯 / 同花顺免费 / baostock / akshare / free-stockdb）**默认按不复权或源站未声明拆分处理**。缓存里实测有 18 处 |单日收益|>22% 的假跳变（A 股 ETF 涨跌停 ±10%/±20%，超过 22% 必为公司行为），例如 513100 于 **2022-01-14** 假跌 −80.5%（1 拆 5）、515880 两次拆分、516160 假涨 +221%（份额合并）。
