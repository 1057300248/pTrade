# -*- coding: utf-8 -*-
"""SimTradeLab first-filter for ptrade_rmdc_etf.py. broker_profile=auto (国金)."""
...
def _copy_strategy():
    src = os.path.join(ROOT, "ptrade_rmdc_etf.py")
    dest_dir = os.path.join(ROOT, "strategies", "ptrade_rmdc_etf")
