# -*- coding: utf-8 -*-
"""SimTradeLab reproduction runner for rejected ptrade_gem_etf.py."""
...
def _copy_strategy():
    src = os.path.join(ROOT, "ptrade_gem_etf.py")
    dest_dir = os.path.join(ROOT, "strategies", "ptrade_gem_etf")
...
def main():
    ...
    print("SimTradeLab GEM first-filter report")
